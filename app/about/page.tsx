...
export default function AboutPage() {
  return (
    <>
      ...
      >
        {/* Hero background image — actual clinic treatment room */}
        <OptimizedImage
          src={SITE_IMAGES.heroAbout}
          alt="Rettay Chiropractic treatment room with chiropractic table and anatomy charts"
          fill
          priority
